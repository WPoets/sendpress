...
class SendPress_Emails_Table extends WP_List_Table {
    ...
    function column_default($item, $column_name){
        switch($column_name){
           ...
           */
            ...
            case 'actions':
                return '<div class="inline-buttons"><a class="btn view-btn" title="'.  get_post_meta($item->ID, "_sendpress_subject", true) . '" href="'. get_permalink( $item->ID  ). '"><i class="icon-eye-open "></i> View</a> <a class="btn " href="?page='.$_REQUEST['page'].'&view=style-email&emailID='. $item->ID .'"><i class="icon-edit"></i> Edit</a> <a class="btn  btn-primary " href="?page='.$_REQUEST['page'].'&view=send-email&emailID='. $item->ID .'"><i class="icon-envelope icon-white"></i> Send</a></div>';
            default:
    ...
    function column_title($item){
        ...
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&view=%s&emailID=%s">Edit</a>',$_REQUEST['page'],'style-email',$item->ID),
            'delete'    => sprintf('<a href="?page=%s&action=%s&emailID=%s">Delete</a>',$_REQUEST['page'],'delete-email',$item->ID),
        );

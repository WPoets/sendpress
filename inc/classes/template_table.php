 ...
 */
class SendPress_Templates_Table extends WP_List_Table {
    ...
    function column_default($item, $column_name){
        switch($column_name){
           ...
           */
            case 'actions':
                return '<div class="inline-buttons"><a class="spbutton left" href="?page='.$_REQUEST['page'].'&view=subscribers&listID='.$item->ID.'">View</a><a class="spbutton right" href="?page='.$_REQUEST['page'].'&view=addsubscriber&listID='. $item->ID .'">Edit</a><a class="spbutton bluebtn" href="?page='.$_REQUEST['page'].'&view=addsubscriber&listID='. $item->ID .'">Send</a></div>';
            default:
    ...
    function column_title($item){
        ...
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&view=%s&emailID=%s&listID=%s">Edit</a>',$_REQUEST['page'],'edit-email',$item->ID, '' ),
    ...
    function column_cb($item){
        return sprintf(
            ...
            /*$2%s*/ ''                //The value of the checkbox should be the record's id
        );
    }
